...
*First convened 2026-07-02 ([full verdict](2026-07-02-council-review.md) · overall 6.5/10). The council is five AI reviewers with deliberately opposing mandates, an independent fact-check bench, and a presiding judge. Saved here so the same panel can be re-invited to judge the project's improvement.*
