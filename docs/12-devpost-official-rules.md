# 12 · Devpost Official Rules — verbatim capture

*Source: <https://qwencloud-hackathon.devpost.com/rules> · captured by **human read 2026-07-02** (the page 403s to automated fetch). This retires the **VERIFY LIVE** tags across docs 03/06/09. Verbatim text below the summary; where any doc disagrees with this page, **this page wins**.*

## What this resolves (the former VERIFY-LIVE items)

| Question | Answer | Exact wording |
|---|---|---|
| Video length (3 vs 5 min?) | **< 3 minutes** | "should be less than three (3) minutes. Judges are not required to watch beyond three minutes" |
| Video host | **YouTube, Vimeo, or Youku**, public | "must be uploaded to and made publicly visible on YouTube, Vimeo, or Youku" |
| Alibaba Cloud deployment | **MANDATORY** — was treated as "insurance"; it is a required submission item | "Include Proof of Alibaba Cloud Deployment: You must demonstrate that the backend is running on Alibaba Cloud. Proof must be a link to a code file in their code repo that demonstrates use of Alibaba Cloud services and APIs" |
| Architecture diagram | **Required** submission item | "Include an Architecture Diagram showing a clear visual representation of your system" |
| Repo / license | Public + OSS license file, **detectable in the GitHub About section** | "must be public and open source by including an open source license file. This license should be detectable and visible at the top of the repository page (in the About section)" |
| 30%-bucket description pairing (doc 03 §3 ⚠) | **Resolved**: "custom skills, MCP integrations" sits under **Innovation & AI Creativity (30%)**; architecture/code quality under **Technical Depth (30%)** | See §6 Judging Criteria below |
| Deadline / judging / winners | **9 Jul 2026 2:00 pm PT** / 10–31 Jul / ~7 Aug | §1 Dates and Timing |

## New obligations we had not planned for

1. **Proof of Alibaba Cloud deployment** is a required submission field — the proof is *a link to a code file in the repo* that demonstrates use of Alibaba Cloud services and APIs. Deploy the backend on Alibaba Cloud AND make sure a repo code file shows the Alibaba Cloud usage.
2. **Testing access**: "Access must be provided to an Entrant's working Project for judging and testing by providing a link to a website, functioning demo, or a test build," free of charge, through the end of judging (31 Jul). Judges *may* judge from video + text alone, but a working link is required.
3. **Pre-existing projects** must have been "significantly updated after the start of the Hackathon Submission Period" and entrants "should explain how their Project was significantly updated" — include that explanation in the Devpost write-up.
4. **Stage One is pass/fail**: the project must "reasonably fit the theme and reasonably apply the required APIs/SDKs" before any weighted judging happens.
5. **Blog Post bonus prize** (10 × $500 cash + $500 credits): publish a public blog/social post about the journey building with Qwen Cloud and include the link in the submission. Separate prize pool — cheap to enter.
6. Video "must not include third party trademarks, or copyrighted music or other material" without permission.
7. All materials in English (or with English translations).
8. A project can win at most one grand prize + one blog-post prize.

---

## Verbatim rules (captured 2026-07-02)
...
| --- | --- | --- | --- | --- |
| Grand Prizes |  |  |  |  |
| Track 1: MemoryAgent | - $7,000 cash + $3,000 cloud credits - Blog post featuring the winning submissions - Swag bag | 1 | All Eligible Submissions | All judging criteria |
| Track 2: AI Showrunner | - $7,000 cash + $3,000 cloud credits - Blog post featuring the winning submissions - Swag bag | 1 | All Eligible Submissions | All judging criteria |
| Track 3: Agent Society | - $7,000 cash + $3,000 cloud credits - Blog post featuring the winning submissions | 1 | All Eligible Submissions | All judging criteria |
| Track 4: Autopilot Agent | - $7,000 cash + $3,000 cloud credits - Blog post featuring the winning submissions - Swag bag | 1 | All Eligible Submissions | All judging criteria |
| Track 5: EdgeAgent | - $7,000 cash + $3,000 cloud credits - Blog post featuring the winning submissions - Swag bag | 1 | All Eligible Submissions | All judging criteria |
| Top 10 Honorable Mention Projects | - $500 cash + $500 cloud credits | 10 | All Eligible Submissions | All judging criteria |
| Bonus Prizes |  |  |  |  |
| Top 10 Blog Post Award | - $500 cash + $500 cloud credits | 10 | Blog Post Submissions | Blog Post Criteria |
...
Information collected by Devpost is subject to Devpost's Privacy Policy, available at https://info.devpost.com/privacy. Information collected from Entrants by the Sponsor is subject to the QwenCloud Privacy Policy, available at [https://www.qwencloud.com/legal/privacy](https://www.qwencloud.com/legal/privacy).
